...
function App() {
    ...
    return (
        <div className="App">
            ...
            <h1 className="pageHeader journeyHeader">About Me</h1>
            <Introduction />
            <div id="journey" ref={journeyRef}></div>
            <h1 className="pageHeader journeyHeader">My journey...</h1>
            <Journey />
            <div id="projects" ref={projectsRef}></div>
            <h1 className="pageHeader projectsHeader">Projects</h1>
            <Projects />
